// /pages/api/BImail/index.js
import db from '@/lib/db';

export default async function handler(req, res) {
  try {
    if (req.method === 'GET') {
      // /api/BImail?userId=123            (opsional)
      // /api/BImail?page=1&perPage=20     (opsional)
      // /api/BImail?q=keyword             (opsional) cari di perihal/nomor_surat
